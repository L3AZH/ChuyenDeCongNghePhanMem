...
import { RichEdit, Interval } from 'devexpress-richedit';import 'jquery';
import 'jqueryui';
...
declare module DevExpress.Analytics {
    ...
    module Internal {
        class CodeResolver {
            ...
            execute(func: any, time?: number): JQuery.Promise<any, any, any>;
        }
...
declare module DevExpress.Analytics {
    ...
    module Criteria {
        ...
        class MachineState {
            ...
            private _isSubline;
            private _getToken;
            processTransitionFunction(pos: number): void;
        }
    ...
    module Widgets {
        ...
        module Internal {
            ...
            class TreeListItemViewModel extends Utils.Disposable {
                ...
                walkOnTree(walkCallBack: (item: TreeListItemViewModel) => void, walkCanselation?: (item: TreeListItemViewModel) => boolean): void;
    ...
    module Analytics {
        ...
        module Wizard {
            ...
            class ConfigureObjectDataSourceParametersPage extends WizardPageBase<IObjectDataSourceWizardState, IObjectDataSourceWizardState> {
                ...
                _chooseObjectParameters: Internal.ChooseObjectParameters;
                constructor();
                canNext(): boolean;
                canFinish(): boolean;
            ...
            class SpecifyJsonConnectionPage extends ChooseJsonConnectionPage {
                private _requestWrapper;
                constructor(connections: any, canCreateNewJsonDataSource: any, _requestWrapper?: QueryBuilder.Utils.RequestWrapper);
                commit(): JQuery.Promise<IJsonDataSourceWizardState, any, any>;
                canNext(): boolean;
            ...
            class ChooseJsonSchemaPage extends WizardPageBase<IJsonDataSourceWizardState, IJsonDataSourceWizardState> {
                ...
                canNext(): boolean;
                canFinish(): boolean;
                constructor(_requestWrapper?: QueryBuilder.Utils.RequestWrapper, _allowObjectRootElements?: boolean);
                commit(): JQuery.Promise<IJsonDataSourceWizardState, any, any>;
                initialize(state: IJsonDataSourceWizardState): JQuery.Promise<any, any, any>;
                reset(): void;
        ...
        module Internal {
            ...
            module Series {
                ...
                class SeriesViewModel extends SeriesTemplateViewModel implements Axis.ICollectionItem {
                    ...
                    private _getUnconvertiblePoint;
                    updateByView(view: SeriesViewViewModel): void;
            ...
            var seriesPointsSorting: Analytics.Utils.ISerializationInfo, seriesPointsSortingKey: Analytics.Utils.ISerializationInfo, legendTextPattern: Analytics.Utils.ISerializationInfo, argumentScaleType: Analytics.Utils.ISerializationInfo, valueScaleType: Analytics.Utils.ISerializationInfo, labelsVisibility: Analytics.Utils.ISerializationInfo, argumentDataMember: Analytics.Utils.ISerializationInfo, valueDataMembersSerializable: Analytics.Utils.ISerializationInfo;
                ...
                module Internal {
                    ...
                    module Toolbar {
                        ...
                        class ToolbarSurface extends Analytics.Utils.Disposable {
                            ...
                            onSelectionChanged: (sender: RichEdit, args: any) => void;
                            onContentReady: (e: {
                                element: any;
                                component: Viewer.Widgets.Internal.IPopupComponent;
                                model: any;
