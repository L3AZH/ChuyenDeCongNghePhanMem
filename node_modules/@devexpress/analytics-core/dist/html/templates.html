...
<script type="text/html" id="dxrd-page-selectitems-list">
    <div class="dxrd-wizard-availabledatasources dx-default-border-style dxd-border-secondary" data-bind="styleunit: { top: $data.canCreateNew() ? 65 : 0 }">
        <div class="dxrd-wizard-list" data-bind="dxList: { dataSource: items, onSelectionChanged: function(e) { selectedItems(e.addedItems) }, selectedItems: selectedItems.peek(), focusStateEnabled:false, editEnabled: true, height: '100%', editConfig: { selectionEnabled: false }, selectionMode: 'single', activeStateEnabled: false, disabled: _createNew, noDataText: $root.dx.Analytics.Internal.noDataText() }">
            <div data-options="dxTemplate : { name: 'item' }">
...
<script type="text/html" id="dx-jsonwizard-parametercollection">
    <div class="dx-field">
        ...
        <div class="dx-jsonwizard-parameter-right-container">
            <div class="dx-jsonwizard-parameter">
                <div data-bind="dxTextBox: { value: value, placeholder: $data.valuePlaceholder() }"></div>
            </div>
        </div>
        <!-- /ko -->
    </div>
...
<script type="text/html" id="dx-objectdatasource-expression-popup">
    <div data-bind="dxExpressionEditor: { options: options, fieldListProvider: $root.dataBindingsProvider, displayNameProvider: $root.displayNameProvider && $root.displayNameProvider(), editorTemplateName: 'dx-expressioneditor-popup', popupVisible: popupVisible }"></div>
</script>
...
<script type="text/html" id="dx-objectdatasource-parameter-editorswitch">
...
<script type="text/html" id="dxrd-page-connectionstring">
    <div class="dxrd-wizard-page">
        <div class="dx-wizard-connections dx-default-border-style dxd-border-secondary">
            <div class="dxrd-wizard-list" data-bind="dxList: { items: _connectionStrings, onSelectionChanged: function(e) { _selectedConnectionString(e.addedItems) },  selectedItems: _selectedConnectionString.peek(), editEnabled: true, editConfig: { selectionEnabled: true }, selectionMode: 'single', activeStateEnabled: false, noDataText: $root.dx.Analytics.Internal.noDataText() }">
                <div data-options="dxTemplate : { name: 'item' }">
...
<script type="text/html" id="dx-combobox">
    <div data-bind="dxLocalizedSelectBox: { dataSource: values, value: value, valueExpr: 'value', displayExpr: 'displayValue', displayCustomValue: true, disabled: disabled, 
         ...
         dxValidator: { validationRules: $data.validationRules || [] }">
    </div>
</script>
...
<script type="text/html" id="dx-combobox-undo">
    <div data-bind="dxLocalizedSelectBox: { dataSource: values, value: generateValue($root.undoEngine), valueExpr: 'value', displayExpr: 'displayValue', displayCustomValue: true, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }, dxValidator: { validationRules: $data.validationRules || [] }">
    </div>
</script>
...
<script type="text/html" id="dxrd-right-panel-template-base">
    <div class="dx-shadow dxd-border-secondary" data-bind="styleunit: { width: tabPanel.headerWidth }, css: tabPanel.cssClasses({'dxrd-tab-panel-border': !tabPanel.collapsed()})">
