    ...
    (function (Analytics) {
        ...
        (function (Wizard) {
            ...
            var ConfigureObjectDataSourceParametersPage = (function (_super) {
                ...
                function ConfigureObjectDataSourceParametersPage() {
                    var _this = _super.call(this) || this;
                    _this._objectDataSource = new Data.ObjectDataSource();
                    _this._disposables.push(_this._chooseObjectParameters = new Internal.ChooseObjectMemberParameters());
                    return _this;
                }
            ...
            function _registerConfigureObjectDataSourceParametersPage(factory) {
                factory.registerMetadata(Wizard.ObjectDataSourceWizardPageId.ConfigureParametersPage, {
                    ...
                    create: function () {
                        return new ConfigureObjectDataSourceParametersPage();
                    },
            ...
            var SpecifyJsonConnectionPage = (function (_super) {
                ...
                function SpecifyJsonConnectionPage(connections, canCreateNewJsonDataSource, _requestWrapper) {
                    if (_requestWrapper === void 0) { _requestWrapper = new QueryBuilder.Utils.RequestWrapper(); }
                    var _this = _super.call(this, connections, canCreateNewJsonDataSource) || this;
                    _this._requestWrapper = _requestWrapper;
                    _this._disposables.push(_this._specifySourceData = new ChooseJsonSourcePage(_requestWrapper));
            ...
            function _registerSpecifyJsonConnectionPage(factory, connections, allowCreateNewJsonConnection) {
                factory.registerMetadata(Wizard.JsonDataSourceWizardPageId.SpecifyJsonConnectionPage, {
                    create: function () { return new SpecifyJsonConnectionPage(connections, allowCreateNewJsonConnection); },
            ...
            var ChooseJsonSourcePage = (function (_super) {
                ...
                function ChooseJsonSourcePage(_requestWrapper) {
                    if (_requestWrapper === void 0) { _requestWrapper = new QueryBuilder.Utils.RequestWrapper(); }
                    var _this = _super.call(this) || this;
                    _this._requestWrapper = _requestWrapper;
            ...
            function _registerChooseJsonSourcePage(factory, requestWrapper) {
                factory.registerMetadata(Wizard.JsonDataSourceWizardPageId.ChooseJsonSourcePage, {
                    ...
                    create: function () {
                        return new ChooseJsonSourcePage(requestWrapper);
                    },
            ...
            var ChooseJsonSchemaPage = (function (_super) {
                ...
                function ChooseJsonSchemaPage(_requestWrapper, _allowObjectRootElements) {
                    if (_requestWrapper === void 0) { _requestWrapper = new QueryBuilder.Utils.RequestWrapper(); }
            ...
            function _registerSqlDataSourceWizardPages(factory, dataSourceWizardOptions) {
                ...
                _registerChooseJsonSourcePage(factory, dataSourceWizardOptions.requestWrapper);
                ...
                _registerConfigureObjectDataSourceParametersPage(factory);
            ...
            function _createMultiQueryDataSourceWizard(factory, dataSourceWizardOptions) {
                if (factory === void 0) { factory = new PageFactory(); }
                dataSourceWizardOptions.wizardSettings.enableObjectDataSource = false;
            ...
            var SpecifyJsonDataSourceSettingsPage = (function (_super) {
                ...
                SpecifyJsonDataSourceSettingsPage.prototype.registerSections = function () {
                    if (this._dataSourceWizardOptions.connectionStrings.json().length > 0) {
                        Analytics.Wizard._registerSpecifyJsonConnectionPage(this._factory, this._dataSourceWizardOptions.connectionStrings.json, this._dataSourceWizardOptions.allowCreateNewJsonConnection);
                    ...
                    if (this._dataSourceWizardOptions.allowCreateNewJsonConnection) {
                        if (this._dataSourceWizardOptions.connectionStrings.json().length === 0) {
                            Analytics.Wizard._registerChooseJsonSourcePage(this._factory, this._dataSourceWizardOptions.requestWrapper);
        ...
        (function (Wizard) {
            ...
            (function (Internal) {
                ...
                var ObjectDataSourceParameterProperty = (function (_super) {
                    ...
                    function ObjectDataSourceParameterProperty(_parameter) {
                        var _this = _super.call(this) || this;
                    ...
                    ObjectDataSourceParameterProperty.prototype._initGetInfo = function (typeValue) {
                        ...
                        var info = [
                            ...
                            this._generateInfo({
                                editor: Analytics.Widgets.coreEditorTemplates.expressionEditor,
                                from: function (val) {
                                    return { value: ko.observable(val) };
                                },
                ...
                var ObjectDataSourceParameterGrid = (function (_super) {
                    ...
                    function ObjectDataSourceParameterGrid(x) {
                        ...
                        _this.createEditorAddOn = function (editor) {
                            ...
                            return {
                                data: addon,
                                templateName: "dx-objectdatasource-parameter-editorswitch"
                            };
                        };
                        return _this;
                    }
                ...
                var ObjectDataSourceParametersModel = (function (_super) {
                    ...
                    function ObjectDataSourceParametersModel(parametersMethod) {
                        var _this = _super.call(this) || this;
                        _this.displayName = parametersMethod.displayName;
                        _this._grids = parametersMethod.parameters.map(function (x) {
                            var param = new ObjectDataSourceParameterProperty(x);
                ...
                var ChooseObjectMemberParameters = (function (_super) {
                    ...
                    function ChooseObjectMemberParameters() {
                        var _this = _super !== null && _super.apply(this, arguments) || this;
                    ...
                    ChooseObjectMemberParameters.prototype._updateParameters = function (propertyName, method) {
                        ...
                        if (method && method.parameters.length > 0)
                            this[propertyName](new ObjectDataSourceParametersModel(method));
                        else
                ...
                var ChooseObjectParameters = (function (_super) {
                    ...
                    function ChooseObjectParameters(selectedCtor, selectedDataMembers) {
                        var _this = _super.call(this) || this;
...
DevExpress.Analytics.Widgets.Internal.SvgTemplatesEngine.addTemplates({
    ...
    'dx-objectdatasource-expression-popup': '<div data-bind="dxExpressionEditor: { options: options, fieldListProvider: $root.dataBindingsProvider, displayNameProvider: $root.displayNameProvider && $root.displayNameProvider(), editorTemplateName: \'dx-expressioneditor-popup\', popupVisible: popupVisible }"></div>',
    ...
    'dx-objectdatasource-parameter-editorswitch': '<div class="dxrd-editormenu-box dxd-property-grid-menu-box-color dxd-back-highlighted" data-bind="css: { \'dxd-state-active\': $data.isExpression() }, dxButtonWithTemplate: { onClick: switchEditors, icon: \'dxrd-svg-wizard-expressions\' }">    </div>',
