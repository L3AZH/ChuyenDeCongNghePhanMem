#pragma checksum "D:\C#\ASP.NET\CDCNPM\CDCNPM\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3a3adaa07a38c9e4ba8fffecf9a3c7a0ffc60fee"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3a3adaa07a38c9e4ba8fffecf9a3c7a0ffc60fee", @"/Views/Home/Index.cshtml")]
                    ...
                    <div class=""col-span-3"">
                        <div class=""ml-[15px]"">
                            <button id=""create-query""
                                    type=""button""
                                    class=""text-gray-900 bg-gray-100 hov");
            WriteLiteral(@"er:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 mr-2 mb-2"">
                                Create query
                            </button>
                            <button type=""button""
                                ...
                                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3a3adaa07a38c9e4ba8fffecf9a3c7a0ffc60fee5783", async() => {
...
");
            DefineSection("Scripts", async() => {
                WriteLiteral("\r\n    <script type=\"text/javascript\">\r\n\r\n\r\n        const dataPresent = JSON.parse(\'");
#nullable restore
#line 87 "D:\C#\ASP.NET\CDCNPM\CDCNPM\Views\Home\Index.cshtml"
                                   Write(Json.Serialize(@Model.listTable));
...
#nullable disable
        ...
        const table_str_condition = (tableName, colName) => `
          ...
          >
            ...
            <div class=""font");
                WriteLiteral(@"-bold text-[12px] col-span-1"">
   ...
   ");
                WriteLiteral(@"             checkboxTablesHtml = checkboxTablesHtml.concat(`
     <div class=""flex mt-4"">
          <label class=""flex items-center"">
            <input
              type=""checkbox""
  ...
  `);
              ...
              <div class=""flex flex-wrap mr-[10px]"">
                <div class=""flex mt-4"">
                  <label class=""flex items-center"">
                    <input
                      type=""checkbox""
                      class=""form-checkbox h-5 w-5 text-gray-600 col-tabl");
    ...
    ");
            ...
            ");
                WriteLiteral(@"    const table = dataset.table;
                ...
                if (checked) {
                    ...
                    selectedCols = selectedCols.filter(
                        (ele) => ele?.name !== value && ele?.tableName === table
                    );

                    $(
                        `#table-section .query-wrapper[data-col=""${foundCol.name}""]`
                    ).remove();
                }
            });
           ...
           ");
              ...
              ");
                ...
                var selectedTables2 = selectedTables.map((tableName) => dataPresent.find((ele) => ele.tableName === tableName));
                var selectedCols2 = selectedCols.map((ele) => ele.options);
                console.log(selectedCols2);
                console.log(selectedTables2);
                const request = {
                    tablePick: selectedTables2,
                    listObject: selectedCols2
                }
                console.log(request)
                $.ajax({
