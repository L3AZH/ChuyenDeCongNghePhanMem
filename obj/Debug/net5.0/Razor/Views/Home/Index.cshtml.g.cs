#pragma checksum "D:\C#\ASP.NET\CDCNPM\CDCNPM\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1f656619197cfa617627e4ad88e0bb1affd4d7fc"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1f656619197cfa617627e4ad88e0bb1affd4d7fc", @"/Views/Home/Index.cshtml")]
...
<div class=""flex h-screen"">
                    ...
                    <div class=""col-span-3"">
                        <div class=""ml-[15px]"">
                            <button id=""create-query""
                                    type=""button""
                  ");
            WriteLiteral(@"                  class=""text-gray-900 bg-teal-300 hover:bg-teal-500 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 mr-2 mb-2"">
                                Create query
                            </button>
                            <button type=""button""
                                ...
                                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1f656619197cfa617627e4ad88e0bb1affd4d7fc6190", async() => {
 ...
 ");
            WriteLiteral(@"               <div class=""header-title font-bold text-[12px] col-span-2"">
                    RenameField
                </div>
        ...
        ");
            WriteLiteral("    <h2 class=\"font-bold mb-[5px]\">Columns List</h2>\r\n            <div class=\"col-wrapper\">\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n\r\n\r\n");
...
#nullable restore
#line 135 "D:\C#\ASP.NET\CDCNPM\CDCNPM\Views\Home\Index.cshtml"
...
#nullable disable
        ...
        const table_str_condition = (tableName, colName) => `
          ...
          >
            ...
            <div class=""font");
                WriteLiteral(@"-bold text-[12px] col-span-2"">
              <div class="""">
                <div class=""mb-3"">
                  <select
        ...
        const checkboxColsOfTableHtml = document.querySelectorAll("".");
                WriteLiteral(@"col-table-check"");
    ...
    ");
      ...
      `);
              ...
              <div
                ...
                data-table = ""${ele.tableName}"" 
               ");
                WriteLiteral(@" id=""UIColOfTable-${ele.tableName}""
              >
              ${hide}
...
");
    ...
    ");
                WriteLiteral(@"                    table_str_condition(foundCol.tableName, foundCol.name)
                    );
                } else {
                    selectedCols = selectedCols.filter(
                        (ele) => `${ele.tableName}-${ele.name}` !== `${table}-${value}`
                ...
                selectedCols = selectedCols.map((ele) => ({
                    ...
                    options: {
                        ...
                        columnPick: dataPresent
                            ...
                            .columns.find((eleRoot2) => eleRoot2.name === ");
                WriteLiteral(@"ele.name),
